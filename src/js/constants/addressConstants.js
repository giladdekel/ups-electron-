...
export const ADDRESS_NAME_REQUEST = "ADDRESS_NAME_REQUEST";
export const ADDRESS_NAME_SUCCESS = "ADDRESS_NAME_SUCCESS";
export const ADDRESS_NAME_FAIL = "ADDRESS_NAME_FAIL";
export const ADDRESS_NAME_RESET = "ADDRESS_NAME_RESET";

export const ADDRESS_IP_REQUEST = "ADDRESS_IP_REQUEST";
export const ADDRESS_IP_SUCCESS = "ADDRESS_IP_SUCCESS";
export const ADDRESS_IP_FAIL = "ADDRESS_IP_FAIL";
export const ADDRESS_IP_RESET = "ADDRESS_IP_RESET";
